...
describe('Organization.vue tests', () => {
  ...
  it('test 1 Organization - Affichage d\'un élément dans la liste des organizations', done => {
    ...
    OrganizationService.query = jest.fn().mockReturnValue(Promise.resolve({
  ...
  it('test 3 Organization - createOrganization', done => {
    ...
    OrganizationService.query = jest.fn().mockReturnValueOnce(Promise.resolve({
      data: []
  ...
  it('test 4 Organization - organizationDetail', done => {
    ...
    wrapper.vm.$nextTick(() => {
      ...
      wrapper.vm.$nextTick(() => {
        ...
        expect($router.push).toHaveBeenCalledWith({ name: 'AdminEntityOrganizationDetails', params: { id: organization1.id } })
      })
      done()
    })
  })
  ...
  it('test 5 Organization - update', done => {
    ...
    OrganizationService.get = jest.fn().mockReturnValue(Promise.resolve({ data: organization1 }))

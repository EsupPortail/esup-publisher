...
<div class='reader'>
    ...
    <button class="btn btn-primary btn-lg" data-bs-toggle="modal" data-bs-target="#saveReaderModal" @click="clear();initFormValidator()">
            ...
            <div class="modal-content">
                <form name="editForm" role="form" class="was-validated" novalidate show-validation>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" id="name"
                                   v-model="reader.name" required minlength="3" maxlength="20">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="displayName" id="displayName"
                                   v-model="reader.displayName" required minlength="3" maxlength="50">
                            <div class="invalid-feedback"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="description" id="description"
                                   v-model="reader.description" required minlength="3" maxlength="512">
                            <div class="invalid-feedback"
                            ...
                            <div class="inline-form">
                                <div v-for="authorizedType in authorizedTypesList" :key="authorizedType" class="form-check form-check-inline">
                                    <input :id="authorizedType" class="form-check-input" type="checkbox"  name="authorizedTypes" :value="authorizedType" :checked="containsSelectedType(authorizedType)"
                                           @click="toggleSelectionType(authorizedType)" :required="formValidator.hasError('authorizedTypes', formErrors.REQUIRED)">
                                    <label :for="authorizedType" class="form-check-label">
                                        <span>{{ $t('enum.itemType.' + authorizedType)}}</span>
                                    </label>
                                </div>
                                <div class="invalid-feedback d-block"
                                    v-if="formValidator.hasError('authorizedTypes', formErrors.REQUIRED)">
                                    {{$t('entity.validation.required')}}
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="inline-form">
                                <div v-for="classificationDecoration in classificationDecorationsList" :key="classificationDecoration" class="form-check form-check-inline">
                                    <input :id="classificationDecoration" class="form-check-input" type="checkbox"  name="classificationDecorations" :value="classificationDecoration" :checked="containsSelectedDecorType(classificationDecoration)"
                                           @click="toggleSelectionDecorType(classificationDecoration)" :required="formValidator.hasError('classificationDecorations', formErrors.REQUIRED)">
                                ...
                                <div class="invalid-feedback d-block"
                                    v-if="formValidator.hasError('classificationDecorations', formErrors.REQUIRED)">
                                    {{$t('entity.validation.required')}}
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" :class="{'disabled': formValidator.hasError() }" @click="createReader" >

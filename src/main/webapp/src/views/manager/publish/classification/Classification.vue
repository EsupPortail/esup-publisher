    ...
    <div class="text-center">
      <div class="btn-group" role="group">
        ...
        <router-link to="content" custom v-slot="{navigate}">
          <button type="button" :disabled="classifications === null || classifications === undefined || classifications.length < 1"
            class="btn btn-default btn-outline-dark btn-nav" @click="navigate">
...
export default {
  ...
  methods: {
    ...
    autoValidateClassif () {
      if (this.publisher.context.redactor.writingMode === 'STATIC' &&
        this.inArray('FLASH', this.publisher.context.reader.authorizedTypes) &&
        this.classifications !== null && this.classifications !== undefined && this.classifications.length > 0) {
    ...
    remove (contextkey) {
      this.setClassifications(this.classifications.filter(element => {
  ...
  created () {
    ...
    if (this.publisher === null || this.publisher === undefined) {
      ...
      if ((this.classifications === null || this.classifications === undefined || CommonUtils.equals([], this.classifications)) && this.contentData && this.contentData.classifications) {

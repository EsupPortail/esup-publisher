    ...
    <div class="attachmentForm">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" name="summary" id="summary" rows="3"
                      v-model="itemSummary" required minlength="5" maxlength="512" />
            <div class="invalid-feedback"
        ...
        <div class="row">
            ...
            <div class="form-group col-md-4">
                ...
                <span v-if="publisher.context.redactor.optionalPublishTime" class="d-block d-md-none">{{ $t('attachment.detail.unlimitedEndDate') }}</span>
            ...
            <div class="form-group col-md-4">
                <label class="control-label me-2" for="rssAllowed">{{ $t('attachment.rssAllowed') }}</label>

<template>
  <div>
    <div class="resourceForm">
      ...
      <div class="row">
        ...
        <div class="form-group col-md-4">
          ...
          <span
            ...
            >{{ $t("resource.detail.unlimitedEndDate") }}</span
          >
          <input
            type="date"
            class="form-control"
      ...
      <div class="form-group">
        <label class="control-label" for="ressourceUrl">{{
          $t("resource.ressourceUrl")
        }}</label>
        <input
          type="url"
          class="form-control"
                ...
                <div class="card-header">
                  ...
                  >
                    <i class="fas fa-folder-open"></i>&nbsp;<span>{{
                      $t("resource.inputfile.upload-button")
                    }}</span>
                  </button>
                  <input
                    type="file"
...
export default {
  ...
  methods: {
    ...
    updateItemValidated() {
      this.setItemValidated(
        !this.formValidator.hasError() && !this.invalidRessourceUrl
      );
    },
  ...
  mounted() {
    ...
    // Si on n'a pas détecté d'erreur mais que l'input est invalide, alors c'est que le texte saisie n'est pas une url
    this.invalidRessourceUrl =
      !this.formValidator.hasError("ressourceUrl") &&
      !this.ressourceUrlInput.checkValidity();
    this.updateItemValidated();
  },
  created() {

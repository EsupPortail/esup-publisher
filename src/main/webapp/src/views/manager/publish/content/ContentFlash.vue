    ...
    <div class="flashForm">
        ...
        <div class="form-group">
            ...
            <div class="form-inline">
                ...
                <img v-if="item.enclosure" id="enclosure" :src="getUrlFromEnclosure()" class="img-responsive img-fluid" :alt="$t('flash.enclosure')"/>
        ...
        <div class="row">
            ...
            <div class="form-group col-md-4">
                ...
                <span v-if="publisher.context.redactor.optionalPublishTime" class="d-block d-md-none">{{ $t('flash.detail.unlimitedEndDate') }}</span>
            ...
            <div class="form-group col-md-4">
                <label class="control-label me-2" for="rssAllowed">{{ $t('flash.rssAllowed') }}</label>

    ...
    <div class="mediaForm">
        ...
        <div class="row">
            ...
            <div class="form-group col-md-4">
                ...
                <span v-if="publisher.context.redactor.optionalPublishTime" class="d-block d-md-none">{{ $t('media.detail.unlimitedEndDate') }}</span>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form name="publishContentEnclosureForm" role="form" novalidate>
                        <div class="card">
                            <h3 class="card-header">{{ $t('media.inputfile.url-label') }}</h3>
                            <div class="card-body">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="d-inline-block me-2">{{ $t('media.inputfile.upload-label') }}</h3>
                            ...
                            <div class="card-body">
                                  <div v-if="content.file" class="card">
                                      <h4 class="card-header mt-0" v-if="content.file.type.match('image/*')">{{ $t('media.inputfile.resizeauto') }}</h4>
                                      <h4 class="card-header mt-0" v-else-if="content.file.type.match('audio/*')">{{ $t('media.inputfile.audio') }}</h4>
                                      <h4 class="card-header mt-0" v-else-if="content.file.type.match('video/*')">{{ $t('media.inputfile.video') }}</h4>
                                      <h4 class="card-header mt-0" v-else>{{ $t('media.inputfile.mediafile') }}</h4>

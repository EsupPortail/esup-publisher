<template>
  ...
  <dl class="row entity-details">
    <dt class="col-sm-5"><span>{{$t('flash.title')}}</span></dt>
  ...
  <dl class="row entity-details" v-if="context.enclosure && context.enclosure !== '' && context.enclosure !== 'http://' ">
    <dt class="col-sm-5"><span>{{$t('flash.enclosure')}}</span></dt>
    <dd class="col-sm-7"><img class="flash-object img-fluid" :src="getUrlEnclosure(context.enclosure)" alt="image" /></dd>
  </dl>
  <dl class="row entity-details">
    <dt class="col-sm-5"><span>{{$t('flash.status')}}</span></dt>
    <dd class="col-sm-7"><span>{{$t(getItemStatusLabel(context.status))}}</span></dd>
  </dl>
  <dl class="row entity-details">
    <dt class="col-sm-5"><span>{{$t('flash.summary')}}</span></dt>
    <dd class="col-sm-7"><span>{{context.summary}}</span></dd>
  </dl>
  <dl class="row entity-details">
    <dt class="col-sm-5"><span>{{$t('flash.body')}}</span></dt>
    <dd class="col-sm-7"><span>{{context.body}}</span></dd>
  </dl>
  <dl class="row entity-details">
    <dt class="col-sm-5"><span>{{$t('flash.startDate')}}</span></dt>
    <dd class="col-sm-7"><span>{{formatDate(context.startDate)}}</span></dd>
  </dl>
  <dl class="row entity-details">
    <dt class="col-sm-5"><span>{{$t('flash.endDate')}}</span></dt>
    <dd class="col-sm-7"><span>{{formatDate(context.endDate)}}</span></dd>
  </dl>
  <dl class="row entity-details">
    <dt class="col-sm-5"><span>{{$t('flash.rssAllowed')}}</span></dt>

<template>
  <div>
    ...
    <dl class="row entity-details" v-has-role="'ROLE_ADMIN'">
      ...
      <dd class="col-sm-7">
        <span
          ><input type="checkbox" v-model="context.allowNotifications" disabled
        /></span>
      </dd>
    </dl>
    <dl class="row entity-details">
      ...
      <dd class="col-sm-7">
        <a :href="appUrl + 'feed/rss/' + context.id" target="_blank"
          >{{ appUrl }}feed/rss/{{ context.id }}</a
        >
      </dd>
    </dl>
        ...
        <div class="modal-content">
          ...
          >
            ...
            <div class="modal-body">
              ...
              <div class="form-group" v-has-role="'ROLE_ADMIN'">
                <label for="identifiers" class="control-label">{{
                  $t("organization.identifiers")
                }}</label>
                <input
                  type="text"
                  id="identifiers"
                ...
                <div
                  class="invalid-feedback"
                  v-if="
                    formValidator.hasError('identifiers', formErrors.REQUIRED)
                  "
                >
                  {{ $t("entity.validation.required") }}
                </div>
              ...
              <div class="form-group" v-has-role="'ROLE_ADMIN'">
                <label for="allowNotifications" class="control-label">{{
                  $t("organization.allowNotifications")
                }}</label>
                <input
                  type="checkbox"

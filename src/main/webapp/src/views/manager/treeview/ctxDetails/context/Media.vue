<template>
  ...
  <dl class="row entity-details">
    <dt class="col-sm-5"><span>{{$t('media.title')}}</span></dt>
  ...
  <dl class="row entity-details" v-if="context.enclosure && context.enclosure !== '' && context.enclosure !== 'http://' ">
    <dt class="col-sm-5"><span>{{$t('media.enclosure')}}</span></dt>
    <dd class="col-sm-7"><img class="media-object img-fluid" :src="getUrlEnclosure(context.enclosure)" alt="image" /></dd>
  </dl>
  <dl class="row entity-details">
    <dt class="col-sm-5"><span>{{$t('media.status')}}</span></dt>
    <dd class="col-sm-7"><span>{{$t(getItemStatusLabel(context.status))}}</span></dd>
  </dl>
  <dl class="row entity-details">
    <dt class="col-sm-5"><span>{{$t('media.summary')}}</span></dt>
    <dd class="col-sm-7"><span>{{context.summary}}</span></dd>
  </dl>
  <dl class="row entity-details">
    <dt class="col-sm-5"><span>{{$t('media.startDate')}}</span></dt>
    <dd class="col-sm-7"><span>{{formatDate(context.startDate)}}</span></dd>
  </dl>
  <dl class="row entity-details">
    <dt class="col-sm-5"><span>{{$t('media.endDate')}}</span></dt>
    <dd class="col-sm-7"><span>{{formatDate(context.endDate)}}</span></dd>
  </dl>
  <dl class="row entity-details">
    <dt class="col-sm-5"><span>{{$t('media.rssAllowed')}}</span></dt>

<template>
  ...
  <div
    v-show="!addPerm"
    aria-labelledby="addPermissionOnContextWithSubjectListLabel"
    aria-hidden="true"
  >
    <form name="editPermOnCtxForm" role="form">
      <div class="header">
        <h4 id="myPermissionOnContextLabel">
          {{
            $t(
              "permissionOnClassificationWithSubjectList.home.createOrEditLabel"
            )
          }}
        </h4>
      </div>
      <div class="body">
        <div class="form-group">
          <label for="permRole">{{
            $t("permissionOnClassificationWithSubjectList.role")
          }}</label>
          <select
            class="form-select"
            id="permRole"
        ...
        <div class="form-group" v-show="permissionAdvanced">
          <label>{{
            $t("permissionOnClassificationWithSubjectList.evaluator")
          }}</label>
          <esup-edit-evaluator
        ...
        >
          <label class="control-label">{{
            $t("permissionOnClassificationWithSubjectList.evaluatorsimple")
          }}</label>
      ...
      <div class="form-group">
        ...
        <ul class="list-group list-unstyled">
          <li
            v-for="target in permission.authorizedSubjects"
            :key="target.keyId"
            class="list-group-item"
          >
            <esup-subject-infos
            ...
            >
              <a
                @click.prevent="removePermTarget(target)"
                v-tooltip="$t('manager.publish.targets.remove')"
                href=""
                ><i class="far fa-times-circle text-danger"></i></a
              >&nbsp;
        ...
        <thead>
          <tr>
            ...
            <th>
              {{
                $t(
                  "permissionOnClassificationWithSubjectList.authorizedSubjects"
                )
              }}
            </th>
            <th class="action"></th>
          ...
          <tr v-for="permission in permissions" :key="permission.id">
            ...
            >
              <ul class="list-unstyled">
                <li
                  v-for="subject in permission.authorizedSubjects"
                  :key="subject"
                  class="list-unstyled"
                >
                  <esup-subject-infos
  ...
  <div
    class="modal fade"
    id="deletePermissionConfirmation"
    ref="deletePermissionConfirmation"
  >

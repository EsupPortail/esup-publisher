...
class SubscriberService {
  ...
  get (subjectCtx) {
    return FetchWrapper.getJson('api/subscribers/' + subjectCtx.subject_id + '/' +
      subjectCtx.subject_type + '/' + subjectCtx.subject_attribute + '/' + subjectCtx.ctx_id + '/' + subjectCtx.ctx_type)
  }
  ...
  delete (subjectCtx) {
    return FetchWrapper.deleteJson('api/subscribers/' + subjectCtx.subject_id + '/' +
    subjectCtx.subject_type + '/' + subjectCtx.subject_attribute + '/' + subjectCtx.ctx_id + '/' + subjectCtx.ctx_type)
  }
